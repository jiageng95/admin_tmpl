...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                uploader,
                // href = location.origin.includes('adminapi') ?  'http://adminapi.jcjob.jclang.me' : 'http://129.226.71.23:8768',
                // actionUrl = `${href}/common/upload`,
                actionUrl = localStorage.getItem('uploadUrl'),
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                // tool.js combineHeader加入请求头
                window.UE.combineHeader(header, { 'X-Requested-With': 'XMLHttpRequest' })
            });
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                list.push({
                    src: prefix + data.file_path,
                    _src: data.url_wechat ? (prefix + data.url_wechat) : (prefix + data.file_path),
                    title: data.title,
                    alt: data.original,
                    floatStyle: align
                });
